...
from neuronlp2.models import BiRecurrentConvCRFChiu, BiVarRecurrentConvCRF
...
def main():
    ...
    if args.dropout == 'std':
        network = BiRecurrentConvCRFChiu(embedd_dim, word_alphabet.size(), char_dim, char_alphabet.size(), num_filters, window, mode, hidden_size, num_layers, num_labels,
