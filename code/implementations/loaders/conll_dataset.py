...
class ConllStyleDataset(Dataset):
    ...
    def __init__(self, dataset, suffix_size, vocab_size,
        ...
        if window_size is not None:
            ...
            for line in self.dataset:
                ...
                if compute_dicts:
                    self.char_set = self.char_set | set(word)
            ...
            for line in self.dataset:
                ...
                # end of document/sentence
                if len(line_s) == 0:
                    if len(tmpX) > 100 or len(tmpX) < 3:  # skip small and large sentences
                        tmpX = []
                        tmpY = []
                        continue
        ...
        if compute_dicts:
            ...
            char_list = sorted(self.char_set)
    ...
    def char_to_index(self, char, padding=False):
        if padding:
            return 0
        else:
    ...
    def get_num_chars(self):
        return len(self.char_to_id)+1  # account for padding char id
